...
function kimiPluginManifest() {
  ...
  return JSON.stringify({
    ...
    name: "null-to-hero",
    version: VERSION,
    description: "From zero knowledge to hero website: design, SEO, whole-site audit and handover skills — 4 skills, 68 commands, 15 audit sub-agents.",
    keywords: claude.keywords,
    author: claude.author.name,
    homepage: claude.homepage,
    license: "Apache-2.0",
    skillInstructions: [
      "NullToHero turns Kimi into a senior web team: a designer, an SEO specialist, a whole-site reviewer and a handover expert. Four skills — nth-siteasy (design and build), nth-seo (search visibility), nth-audit (the whole site in one pass), nth-cms (hand the site to its owner) — with 68 commands and 15 audit sub-agents.",
      "",
