...
- **Split text:** individual characters/words animate with stagger (30-50ms per element for fluid, 100ms+ for dramatic)
...
### Budget
- **LCP:** under 2.5s (target under 2s)
- **CLS:** under 0.1
...
### Staged approach
1. **CSS Design Awards** first (~US$49) — most accessible, build credibility, validate ergonomics
2. **FWA** (free–US$35) — rewards creativity and experimentation
3. **Awwwards** (~US$75) — the industry standard, highest scrutiny
4. **Webby Awards** (US$200–500) — broadest recognition, corporate credibility
