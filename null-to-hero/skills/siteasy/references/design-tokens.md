---
name: design-tokens
description: "The two-layer token architecture, the naming vocabulary that keeps two sessions consistent, and the mistakes that dissolve a token system. Load for /siteasy tokens, /siteasy build and /siteasy extract."
version: 2.0.0
---
