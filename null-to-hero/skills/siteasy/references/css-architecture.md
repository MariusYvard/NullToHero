...
description: "Which CSS architecture to reach for, and why: layer order, isolation, token flow and the decisions that outlive a framework. Load for /siteasy build, /siteasy extract, and any work touching a project's CSS foundation."
version: 2.0.0
---
