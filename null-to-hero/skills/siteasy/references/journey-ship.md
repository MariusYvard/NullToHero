...
| 4 | Hardening | `/siteasy harden` ([harden.md](harden.md), [optimize.md](optimize.md), [ship-checklist.md](ship-checklist.md)) | Ship checklist clean, Core Web Vitals within budget; iOS-sensitive features carry the required evidence from [mobile-ios-validation.md](mobile-ios-validation.md); changed URLs pinged via [/seo indexnow](../../seo/references/indexnow.md) on content and brand sites |
