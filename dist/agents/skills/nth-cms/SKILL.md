...
---
<!-- Generated for Agent Skills (open standard) from null-to-hero/skills/cms/.
     Do not edit here. Edit the source and run tools/build-dist.mjs. -->

## Host notes

Invoke this skill with `nth-cms`, or by asking for it by name. Its commands are written `/nth-cms <command>` below.
