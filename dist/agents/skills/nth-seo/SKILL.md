...
---
<!-- Generated for Agent Skills (open standard) from null-to-hero/skills/seo/.
     Do not edit here. Edit the source and run tools/build-dist.mjs. -->

## Host notes

Invoke this skill with `nth-seo`, or by asking for it by name. Its commands are written `/nth-seo <command>` below.
...
1. Load the matching reference file using the file reader
