...
---
<!-- Generated for Hermes Agent from null-to-hero/skills/cms/.
     Do not edit here. Edit the source and run tools/build-dist.mjs. -->

## Host notes

Invoke this skill with the `nth-cms` skill (say what you want and Hermes picks it, or load it explicitly with `skill_view`). Its commands are written `/nth-cms <command>` below.
