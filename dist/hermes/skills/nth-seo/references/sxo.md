...
| Mobile experience fails | Escalate to `/nth-siteasy adapt` for responsive design fixes. |

## CROSS-SKILL REFERENCES

| Need | Skill |
|------|-------|
| Keyword intent grouping | `/nth-seo cluster` |
| Content depth and E-E-A-T | `/nth-seo content` |
| UX research and personas | `/nth-siteasy research` |
| Information architecture | `/nth-siteasy ia` |
| Journey mapping | `/nth-siteasy research` |
| Mobile and responsive design | `/nth-siteasy adapt` |
| Full audit | `/nth-seo audit` |
