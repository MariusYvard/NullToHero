...
| Crawler access rules and llms.txt for layer 1 | `/nth-seo geo` |
| Before and after site state around a change | `/nth-seo drift baseline`, `/nth-seo drift compare` |
| Rendering, status codes and robots for layer 1 | `/nth-seo technical` |
