...
| Technical audit | `/nth-seo technical` |
| Schema for local business pages | `/nth-seo local` |
| ImageObject schema | `/nth-seo images` |
| Live structured data analysis | (not included) |
| Schema on web pages | `/nth-siteasy build` |
| Comparison page schema | `/nth-seo competitor-pages` |
