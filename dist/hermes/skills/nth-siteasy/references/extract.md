...
**CRITICAL**: If no design system exists, STOP and call the clarify tool to clarify before creating one. Understand the preferred location and structure first.
