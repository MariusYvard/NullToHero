---
name: rendered
description: "Run the seven registry rules that need a laid-out page, in a connected browser or in Playwright, from one probe."
version: 1.4.0
---
...
**a connected browser.** The path for a live site, a page behind a login, or
...
In a connected browser it is two pastes, because the sampler is installed as a page
