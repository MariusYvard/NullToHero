...
description: >
  ...
  /nth-cms entrust and /nth-cms scaffold.
---
...
## 1. Read the site
    ...
    node "${NTH_ROOT}/tools/cms/content-map.mjs" . --json
...
## 2. Propose the fields
    ...
    node "${NTH_ROOT}/tools/cms/content-carve.mjs" . 
...
## 4. Write
    ...
    node "${NTH_ROOT}/tools/cms/content-carve.mjs" . --write
    node "${NTH_ROOT}/tools/cms/cms-scaffold.mjs" .
...
Then the editor itself:
    ...
    node "${NTH_ROOT}/tools/cms/vendor-decap.mjs" .
...
## 6. Hand over
    ...
    node "${NTH_ROOT}/tools/cms/cms-account.mjs" add someone@example.com --roles editor
