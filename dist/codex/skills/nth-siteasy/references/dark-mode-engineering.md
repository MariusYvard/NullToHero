...
description: "The values dark mode needs and the traps it sets: elevation by lightness, accent and weight adjustments, the flash, and third-party content. Load for /nth-siteasy build, /nth-siteasy tokens, and any theming work."
version: 2.0.0
---
