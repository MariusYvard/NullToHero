...
---
<!-- Generated for OpenAI Codex from null-to-hero/skills/seo/.
     Do not edit here. Edit the source and run tools/build-dist.mjs. -->

## Host notes

Invoke this skill with `$nth-seo`, or pick it from `/skills`. Its commands are written `/nth-seo <command>` below.
