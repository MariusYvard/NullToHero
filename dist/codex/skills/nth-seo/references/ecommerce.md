...
| Need | Skill |
|------|-------|
| Product and review schema | `/nth-seo schema` |
| Image SEO (product photos) | `/nth-seo images` |
| Sitemap for product catalog | `/nth-seo sitemap` |
| International e-commerce | `/nth-seo hreflang` |
| Programmatic category pages | `/nth-seo programmatic` |
