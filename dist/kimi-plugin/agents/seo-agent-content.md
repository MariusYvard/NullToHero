...
description: "Sub-agent for the Content quality dimension of /nth-audit (and /nth-seo audit). Evaluates E-E-A-T signals, title tags, meta descriptions, heading structure, keyword usage, readability, thin content, and AI citation readiness. Not for whether the copy reads well as interface writing, use siteasy-agent-content instead; not for whether a claim is defensible, use siteasy-agent-claims."
tools:
  - Read
  - ReadMediaFile
  - Glob
...
<!-- Generated from null-to-hero/agents/seo-agent-content.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| Deep content audit | `/nth-seo content [url]` |
| E-E-A-T deep dive | `/nth-seo content [url]` |
| AI search optimization | `/nth-seo geo [url]` |
