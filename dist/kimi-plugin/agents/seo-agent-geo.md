---
name: seo-agent-geo
description: "Sub-agent for the GEO (Generative Engine Optimization) dimension of /nth-audit (and /nth-seo audit). Evaluates AI crawler access, llms.txt compliance, passage citability, brand authority signals, and platform-specific visibility. Not for classic crawlability and indexing, use seo-agent-technical instead; not for the substance of the text being cited, use seo-agent-content."
tools:
  - Read
  - ReadMediaFile
  - Glob
...
<!-- Generated from null-to-hero/agents/seo-agent-geo.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| Full GEO audit | `/nth-seo geo [url]` |
| GEO quick snapshot | `/nth-seo geo quick [url]` |
| GEO vs baseline | `/nth-seo geo compare [url]` |
