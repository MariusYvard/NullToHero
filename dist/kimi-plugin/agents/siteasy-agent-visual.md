...
<!-- Generated from null-to-hero/agents/siteasy-agent-visual.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| Typography | `/nth-siteasy typeset` |
| Color | `/nth-siteasy amplify` |
| Bolder or quieter | `/nth-siteasy amplify` |
| Layout | `/nth-siteasy layout` |
