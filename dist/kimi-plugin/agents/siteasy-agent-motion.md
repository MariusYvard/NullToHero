...
<!-- Generated from null-to-hero/agents/siteasy-agent-motion.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| Animation | `/nth-siteasy animate` |
| Parallax | `/nth-siteasy parallax` |
| Delight | `/nth-siteasy delight` |
| Overdrive | `/nth-siteasy overdrive` |
