...
When `/nth-seo programmatic plan` is called:
...
| Need | Skill |
|------|-------|
| URL structure and canonicals | `/nth-seo technical` |
| Sitemap for programmatic pages | `/nth-seo sitemap` |
| Schema for programmatic pages | `/nth-seo schema` |
| Content quality audit | `/nth-seo content` |
| Semantic clustering to find keyword matrix | `/nth-seo cluster` |
