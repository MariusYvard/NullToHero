...
An advisory rubric for `/nth-siteasy critique`. It scores whether a page sells, which is a separate question from whether it is usable or whether its claims are evidenced.
