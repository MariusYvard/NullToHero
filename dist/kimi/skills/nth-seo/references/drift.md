...
| Need | Skill |
|------|-------|
| Full technical audit (when drift reveals technical issues) | `/nth-seo technical` |
| Full site audit | `/nth-seo audit` |
| Schema validation | `/nth-seo schema` |
| AI crawler access check | `/nth-seo geo` |
| Content quality check | `/nth-seo content` |
