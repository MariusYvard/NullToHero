...
| Need | Skill |
|---------------|-------|
| Full site-wide audit | `/nth-seo audit` |
| Technical deep-dive | `/nth-seo technical` |
| Content quality & E-E-A-T | `/nth-seo content` |
| Schema & structured data | `/nth-seo schema` |
| Page image optimization | `/nth-seo images` |
| Page AI citability | `/nth-seo geo` |
