...
description: "Sub-agent for the Performance dimension of /nth-audit (and /nth-seo audit). Evaluates page speed signals, image optimization, font loading, render-blocking resources, and Core Web Vitals readiness. Not for layout shift caused by CSS bugs, use inspect-agent-layout instead; not for perceived speed of animation, use siteasy-agent-motion."
tools:
  - Read
  - ReadMediaFile
  - Glob
...
<!-- Generated from null-to-hero/agents/seo-agent-performance.md. Do not edit here. -->
