---
name: refine
description: "Bounded refinement loop for /nth-audit: a veto gate that can block before any round, then at most three rounds revising the three lowest weighted contributions, with a full rescore, four stop conditions and a reported round counter."
version: 2.3.0
---

# Bounded Refinement

The convergence loop behind `/nth-audit refine`. It takes a scored deliverable and a target
...
`/nth-audit` command measures and reports. That difference is what makes the bounds below
