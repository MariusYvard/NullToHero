...
- [ ] If the site is meant to be indexed, ping the search engines: submit the sitemap and, where supported, send the changed URLs to IndexNow ([/nth-seo indexnow](../../seo/references/indexnow.md)).
