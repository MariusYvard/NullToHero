...
| Need | Skill |
|------|-------|
| SEO strategy and roadmap | `/nth-seo plan` |
| Content quality for cluster pages | `/nth-seo content` |
| Competitor comparison cluster pages | `/nth-seo competitor-pages` |
| Programmatic SEO for large clusters | `/nth-seo programmatic` |
| SXO — matching intent to experience | `/nth-seo page` |
