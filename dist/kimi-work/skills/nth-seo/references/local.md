...
Generate or validate schema for the business. See `/nth-seo schema` for full templates.
...
| Need | Skill |
|------|-------|
| LocalBusiness schema generation | `/nth-seo schema` |
| Full technical audit | `/nth-seo technical` |
| Content quality for location pages | `/nth-seo content` |
| Multi-location sitemap | `/nth-seo sitemap` |
