...
description: "Sub-agent for the Schema markup dimension of /nth-audit (and /nth-seo audit). Detects existing JSON-LD, validates required and recommended properties, checks for rich result eligibility, and flags critical errors. Not for markup semantics in general, use inspect-agent-code instead; not for the content the markup describes, use seo-agent-content."
tools:
  - Read
  - ReadMediaFile
  - Glob
...
<!-- Generated from null-to-hero/agents/seo-agent-schema.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| Generate or fix schema | `/nth-seo schema [url]` |
| Product schema | `/nth-seo ecommerce [url]` |
| LocalBusiness schema | `/nth-seo local [url]` |
