...
<!-- Generated from null-to-hero/agents/siteasy-agent-claims.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| UX writing | `/nth-siteasy clarify` |
| Landing structure and proof | `/nth-siteasy shape` |
| E-E-A-T and content SEO | `/nth-seo content` |
