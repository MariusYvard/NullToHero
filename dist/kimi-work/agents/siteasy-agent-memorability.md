...
description: "Sub-agent for the Memorability dimension of /nth-audit (and /nth-siteasy). Evaluates point of view, a signature element, distinctive typography, ownable color, surprise and voice, and restraint against template-shaped design. Not for whether the system is internally consistent, use siteasy-agent-visual instead; not for motion as a signature, use siteasy-agent-motion."
tools:
  - Read
  - ReadMediaFile
  - Glob
...
<!-- Generated from null-to-hero/agents/siteasy-agent-memorability.md. Do not edit here. -->
...
| Need | Skill |
|------|-------|
| Set the idea | `/nth-siteasy concept` |
| A signature moment | `/nth-siteasy overdrive` |
| Type and color identity | `/nth-siteasy typeset`, `/nth-siteasy amplify` |
