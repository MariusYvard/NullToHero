...
- `inspect-rules.csv` — Do/Don't rules with good and bad code examples (68 rules), consumable by `/inspect` as editable detection rules. Authored for NullToHero; schema and severity model inspired by ui-ux-pro-max-skill (MIT). See ../ATTRIBUTION.md.
