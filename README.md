...
> **v1.17.0** · 4 skills · 58 commands · 92 reference docs · 13 audit sub-agents
...
NullToHero ships **92 reference docs** that Claude loads only when it needs them, so a large project does not eat your context budget.
