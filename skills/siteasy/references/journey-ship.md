...
| 4 | Hardening | `/siteasy launch` ([harden.md](harden.md), [optimize.md](optimize.md), [ship-checklist.md](ship-checklist.md)) | Ship checklist clean, Core Web Vitals within budget |
