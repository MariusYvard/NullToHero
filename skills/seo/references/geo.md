...
description: >
  ...
  Generative Engine Optimization specialist. Use for: "AI search", "AI
  Overviews", "GEO", "llms.txt", "AI crawler", "passage citability", "ChatGPT
  visibility", "Perplexity ranking", "brand mentions".
version: 1.0.0
user-invocable: true
argument-hint: "[url]"
---
...
| Données IA en direct (ChatGPT scraper, LLM mentions) / Live AI data | (not included) |
| Qualité et citabilité du contenu / Content quality & citability | `/seo content` |
| Données structurées pour IA / Structured data for AI | `/seo schema` |
| Stratégie SEO organique / Organic SEO strategy | `/seo plan` |
| Mentions de marque et PR / Brand mentions & PR | (not included) |
| Recherche de sources citées / Research on cited sources | (not included) |
